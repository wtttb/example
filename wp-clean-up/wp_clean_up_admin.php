...
?>
	<div class="wrap">
		...
		<table class="widefat" style="width:419px;">
			<thead>
				<tr>
					<th scope="col"><?= __('Type', 'WP-Clean-Up'); ?></th>
					<th scope="col"><?= __('Count', 'WP-Clean-Up'); ?></th>
					<th scope="col"><?= __('Operate', 'WP-Clean-Up'); ?></th>
				</tr>
			</thead>
			<tbody id="the-list">
				<tr class="alternate">
					<td class="column-name"><?= __('Revision', 'WP-Clean-Up'); ?></td>
					...
					<td class="column-name">
						<form action="" method="post">
							...
							<input type="submit" class="<?php if (wp_clean_up_count('revision') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
						</form>
					</td>
				</tr>
				<tr>
					<td class="column-name"><?= __('Draft', 'WP-Clean-Up'); ?></td>
					<td class="column-name"><?php echo wp_clean_up_count('draft'); ?></td>
					<td class="column-name">
						<form action="" method="post">
							<input type="hidden" name="wp_clean_up_draft" value="draft" />
							<input type="submit" class="<?php if (wp_clean_up_count('draft') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
				...
				<tr class="alternate">
					<td class="column-name"><?= __('Spam Comments', 'WP-Clean-Up'); ?></td>
					<td class="column-name"><?php echo wp_clean_up_count('spam'); ?></td>
					<td class="column-name">
						<form action="" method="post">
							<input type="hidden" name="wp_clean_up_spam" value="spam" />
							<input type="submit" class="<?php if (wp_clean_up_count('spam') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
				...
				<tr>
					<td class="column-name"><?= __('Trash Comments', 'WP-Clean-Up'); ?></td>
					<td class="column-name"><?php echo wp_clean_up_count('trash'); ?></td>
					<td class="column-name">
						<form action="" method="post">
							<input type="hidden" name="wp_clean_up_trash" value="trash" />
							<input type="submit" class="<?php if (wp_clean_up_count('trash') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
				...
				<tr>
					<td class="column-name"><?= __('Orphan Commentmeta', 'WP-Clean-Up'); ?></td>
					...
					<td class="column-name">
						<form action="" method="post">
							...
							<input type="submit" class="<?php if (wp_clean_up_count('commentmeta') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
				...
				<tr class="alternate">
					<td class="column-name"><?= __('Orphan Relationships', 'WP-Clean-Up'); ?></td>
					...
					<td class="column-name">
						<form action="" method="post">
							...
							<input type="submit" class="<?php if (wp_clean_up_count('relationships') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
				...
				<tr>
					<td class="column-name"><?= __('Dashboard Transient Feed', 'WP-Clean-Up'); ?></td>
					<td class="column-name"><?php echo wp_clean_up_count('feed'); ?></td>
					<td class="column-name">
						<form action="" method="post">
							<input type="hidden" name="wp_clean_up_feed" value="feed" />
							<input type="submit" class="<?php if (wp_clean_up_count('feed') > 0) {
																						echo 'button-primary';
																					} else {
																						echo 'button';
																					} ?>" value="<?= __('Delete', 'WP-Clean-Up'); ?>" />
		...
		<form action="" method="post">
			...
			<input type="submit" class="button-primary" value="<?= __('Delete All', 'WP-Clean-Up'); ?>" />
		</form>
		</p>
		<br />
		<table class="widefat" style="width:419px;">
			<thead>
				<tr>
					<th scope="col"><?= __('Table', 'WP-Clean-Up'); ?></th>
					<th scope="col"><?= __('Size', 'WP-Clean-Up'); ?></th>
				</tr>
			</thead>
			<tbody id="the-list">
				<?php
			...
			<tfoot>
				<tr>
					<th scope="col"><?= __('Total', 'WP-Clean-Up'); ?></th>
		...
		<form action="" method="post">
			...
			<input type="submit" class="button-primary" value="<?= __('Optimize', 'WP-Clean-Up'); ?>" />
		</form>
		</p>
	</div>
<?php
